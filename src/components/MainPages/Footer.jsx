...
const socialLinks = [
  {
    path:"https://www.youtube.com/@prakashprasad3112",
    icon: <AiFillYoutube className='group-hover:text-white group-hover:bg-[#7B22FA] w-4 h-5'/>
  },
  {
    path:"https://github.com/prakash-prasad22",
    icon: <AiFillGithub className='group-hover:text-white group-hover:bg-[#7B22FA] w-4 h-5'/>
  },
  {
    path:"https://www.instagram.com/prakash_prasad22/?next=%2F",
    icon: <AiOutlineInstagram className='group-hover:text-white group-hover:bg-[#7B22FA] w-4 h-5'/>
  },
  {
    path:"https://www.linkedin.com/in/prakash-prasad-rai-4386081b9/",
        ...
        <div className='flex justify-between flex-col md:flex-row flex-wrap gap-[30px]'>
          <div>
            ...
            <p className='text-[16px] leading-7 font-[400] text-textColor mt-4'>
              Copyright @ {year} developed by Prakash Prasad .. all right reserved.
            </p>
